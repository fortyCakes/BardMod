...
@AutoAdd.Ignore
public class TaleCollector extends CustomCard {
    ...
    public void upgrade() {
        if (!this.upgraded) {
            upgradeName();
            upgradeDamage(UPGRADE_PLUS_MULTIPLIER);
        }
    }
    ...
    public void calculateCardDamage(AbstractMonster mo) {
        ...
        ArrayList<String> currentSaveEvents = AbstractDungeon.eventList;
        // TODO Work out how to get number of ? rooms visited
    }
}
