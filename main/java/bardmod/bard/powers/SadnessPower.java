...
public class SadnessPower
    ...
    public void atEndOfTurn(boolean isPlayer) {
        ...
        if (this.amount == 0) {
            addToBot((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, "Sadness"));
        } else {
            addToBot((AbstractGameAction)new ReducePowerAction(this.owner, this.owner, "Sadness", 1));
        }
/*    */   }
}